...
def experiment_prompt_base(args):
    if not args.log_file:
        logger = set_logger(f'../results_MR/prompt_ctc/{args.dataset}_{args.shot_count}_shot_@{datetime.now().strftime("%Y_%m_%d-%H_%M_%S")}.log')
    else:
    ...
    template_text = '{"placeholder":"text_a"} {"soft"} {"placeholder":"text_b"} {"soft"} {"mask"}.'
