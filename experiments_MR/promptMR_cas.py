# Continuous Answer Search based PromptMR
...
def experiment_prompt_base(args):
    if not args.log_file:
        logger = set_logger(f'../results_MR/prompt_cas/{args.dataset}_{args.shot_count}_shot_@{datetime.now().strftime("%Y_%m_%d-%H_%M_%S")}.log')
    else:
